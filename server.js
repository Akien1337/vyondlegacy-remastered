...
const sccbro = require("./static/pageccbro");
const scccopy = require("./static/pagecccopy");
const sembed = require("./static/pageembed");
const lvm = require("./static/pagelvm");
...
const functions = [mvL, pmc, asl, chl, thl, thL, chs, cht, asL, tsl, chr, ast, mvm, mvl, mvs, mvt, tsv, asu, mvu, stp, scc, slv, lvm, sccbro, scccopy, sembed, stl];
